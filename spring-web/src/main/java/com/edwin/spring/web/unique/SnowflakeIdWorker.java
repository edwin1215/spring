package com.edwin.spring.web.unique;
        ...
        for (int i = 0; i < 10; i++) {
            for (int j = 0; j < 10; j++) {
                ...
                //for (int k = 0; k < 1000; k++) {
                    ...
                    System.out.println("workid: " + i + ", datacenterId: " + j + "[" + Long.toBinaryString(id) + "]");
                    System.out.println("workid: " + i + ", datacenterId: " + j + "[" + id + "]");
                //}
            }
        }
...
//        System.out.println(1 << 3 | 1 << 2 | 1 << 1 | 1);
//        System.out.println(Integer.toBinaryString(1 << 3 | 1 << 2 | 1 << 1 | 1));
    }
}